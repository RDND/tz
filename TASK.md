UI страница с двумя инпут полями, 2 кнопки (зеленая с плюсом и красная с минусом) 
и маленькое окошко желтого цвета которое будет менять цвет по результату операций 
этих двух цифр с цифрой из бд, но только если результат вычислений больше нуля.
По умолчанию, в полях 1 и 1. 
Примеры:
